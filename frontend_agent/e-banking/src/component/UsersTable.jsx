                            ...
                            filteredUsers.map((user, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <Td textAlign="center">
                                            <Badge borderRadius="full" px="2" fontSize="0.8em" colorScheme={
                                        ...
                                        <Td textAlign="center"><Badge colorScheme="blue" borderRadius="full" px="2">{user.cardCount}</Badge></Td>
                                        <Td textAlign="center"><Badge colorScheme="purple" borderRadius="full" px="2">{user.physicalCards}</Badge></Td>
                                        <Td textAlign="center"><Badge colorScheme="pink" borderRadius="full" px="2">{user.virtualCards}</Badge></Td>
                                        <Td textAlign="center">
                                            <Flex justify="center">
                                                <IconButton
                                                    icon={<FiDetails />}
                                                    ...
                                                    onClick={() => navigate('/users/details')} // ✅ Navigate to detail page
                                                />
                                            </Flex>
                                        </Td>
                                    </Tr>
