    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/cardholders/reset-password", "/api/cardholders/verify-username","/api/cardholders/verify-otp","/api/cardholders/internal/by-username/{username}").permitAll()
