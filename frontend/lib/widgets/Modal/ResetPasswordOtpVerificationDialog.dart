...
class ResetPasswordOtpVerificationDialog extends StatefulWidget {
  final void Function(String otp) onConfirmed;
  final String username;

  const ResetPasswordOtpVerificationDialog({
    Key? key,
  ...
  @override
  State<ResetPasswordOtpVerificationDialog> createState() => _ResetPasswordOtpVerificationDialogState();
}

class _ResetPasswordOtpVerificationDialogState extends State<ResetPasswordOtpVerificationDialog>
  ...
  /// Generate OTP for password reset using OtpService
  Future<void> _generateOtp() async {
    try {
      await OtpService.generateOtp(widget.username);
    } catch (_) {
  ...
  Future<void> _validateOtp() async {
    ...
    try {
      isValid = await OtpService.verifyOtp(username: widget.username, otp: code);
    } catch (_) {
      isValid = false;
    }
