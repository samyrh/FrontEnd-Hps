...
class UltraSwitch extends StatefulWidget {
  final bool value;
  ...
  @override
  State<UltraSwitch> createState() => _UltraSwitchState();
}

class _UltraSwitchState extends State<UltraSwitch>
  ...
  void initState() {
    ...
    _controller = AnimationController(
      vsync: this,
      duration: const Duration(milliseconds: 420), // slower = smoother
    );
  ...
  @override
  void didUpdateWidget(UltraSwitch oldWidget) {
